        ...
        child: ListView(
          children: [
            Padding(
              ...
              child: Center(child: Text("Post Your Event",style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                      flex:2,
                      child: Text('Does this Event has poster ?',style: TextStyle(
                          fontSize: 18.0
                      ),)),
                  Expanded(
                    flex: 1,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                      flex:2,
                      child: Text('Does this Event has Content ?',style: TextStyle(
                          fontSize: 18.0
                      ),)),
                  Expanded(
                    flex: 1,
